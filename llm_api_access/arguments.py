...
@dataclasses.dataclass
class LLMArguments(BaseArguments):
    ...
    base_url: str = dataclasses.field(
        default="https://api.openai.com/v1", metadata={"help": "API base URL. Defaults to 'https://api.openai.com/v1'."}
    )
...
class GenerationArguments(BaseArguments):
    ...
    top_p: float = dataclasses.field(
        default=1, metadata={"help": "The top_p of LLM."}
    )
    n: int = dataclasses.field(
        default=1, metadata={"help": "Number of text sequences returned by LLM in just one query."}
    )
    max_completion_tokens: int = dataclasses.field(
        default=256, metadata={"help": "Maximum tokens generated by LLM in one query."}
    )
...
class DataArguments(BaseArguments):
    ...
    dataset_filepath: str = dataclasses.field(
        default="", metadata={"help": "The path to the dataset file."}
    )
    output_filepath: str = dataclasses.field(
        default="",
        metadata={"help": "The file path to save llm-generated contents in."}
    )
    regenerate: bool = dataclasses.field(
        default=False, metadata={"help": "If overwrite existing data and regenerate. Defaults to 'False'."}
    )


@dataclasses.dataclass
class RunningArguments(BaseArguments):
    num_threads: int = dataclasses.field(
    ...
    save_as_json: bool = dataclasses.field(
        default=False, metadata={"help": "Determine if saves the output as JSON file or JSONL file."}
    )


@dataclasses.dataclass
class EntireArguments(LLMArguments, GenerationArguments, DataArguments, RunningArguments):
    pass
